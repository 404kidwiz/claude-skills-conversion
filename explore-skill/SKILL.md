...
- Find where similar functionality is implemented differently
- Identify inconsistencies in implementation patterns
- Discover refactoring opportunities
- Track evolution of patterns across the codebase

### Implicit Relationship Detection
- Identify modules that interact through shared data structures
- Find components that follow similar design patterns
- Discover hidden dependencies through shared utilities or imports

### Architecture Inference
- Deduce architectural decisions from implementation patterns
- Identify the architectural style (layered, hexagonal, clean, etc.)
